...
import {getProduct,productReview} from '../store/action/productActionCreator';
            ...
            <Row>
                ...
                <Col md={4}>
                    <ListGroup variant="flush">
                        ...
                        <ListGroup.Item>
                                Description: <span className="pl-2">  {product.description} </span>
                        </ListGroup.Item>
                    </ListGroup>
                </Col>
                <Col md={3}>
                    <Card>
                        <ListGroup variant="flush">
                            ...
                            <ListGroup.Item>
                                ...
                                type="submit" className="btn btn-block" disabled={product.countInStock === 0}>Add to Cart</Button>
                            </ListGroup.Item>
                        </ListGroup>
                    </Card>
                </Col>
